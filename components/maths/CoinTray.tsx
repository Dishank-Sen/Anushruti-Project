        ...
        <div className="flex flex-wrap gap-3">
          {availableCoins.map((coinVal) => (
            <button
              ...
              className="min-w-[56px] min-h-[56px] px-4 py-2 rounded-2xl bg-[var(--maths-tint)] border-2 border-[light-dark(#CBD0DD,#4d5875)] text-[var(--ink)] font-bold text-lg shadow-[0_3px_0_#A8B0C0] active:translate-y-[2px] active:shadow-none transition flex items-center gap-1.5"
          ...
          <div className="flex flex-wrap gap-2">
            {coins.map((coin, index) => (
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-[var(--surface)] border border-[light-dark(#CBD0DD,#4d5875)] text-xs font-bold shadow-xs hover:border-[var(--retry)] transition flex items-center gap-1"
