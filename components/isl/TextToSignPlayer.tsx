...
import { FITZGERALD_COLORS } from '../../lib/fitzgerald.ts';

const EXPLAINER_CHIPS = [
  { key: 'subject' as const, label: 'Who',    ariaLabel: 'Orange — Who or Subject' },
  { key: 'verb'    as const, label: 'Action', ariaLabel: 'Green — Action or Verb'  },
  { key: 'object'  as const, label: 'What',   ariaLabel: 'Yellow — What or Object' },
  { key: 'place'   as const, label: 'Where',  ariaLabel: 'Blue — Where or Location'},
];
    ...
    >
      ...
      <div>
        ...
        <div className="text-lg">
          <FitzgeraldText text="Cat has three apples" enabled={true} showLabels={true} />
        </div>
      </div>
    </section>
  );
