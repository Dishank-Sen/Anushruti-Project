...
export const chapter03: MathsChapter = {
  ...
  icon: '🥭',
  coverImage: '/images/maths/c03.jpg',
  themeColor: '#FFA502',
  status: 'ready',
  ncertPage: 17,
  islVocab: [
  ...
  lessons: [
    ...
    {
      id: 'mango-sharing-problem',
      chapterId: 'maths-c03',
      grade: 1,
      title: 'Problem solving: Sharing mangoes',
      description: 'Calculate how many fruits remain after friends share.',
      minutes: 5,
      ...
      steps: [
        ...
        {
          visual: '🥭 🥭 🥭 🥭  ... 🥭 🥭 💨',
          title: 'Two are shared',
          text: 'Two mangoes are given to the visitors.',
        },
        {
          visual: '🥭 🥭 🥭 🥭 = 4',
          title: 'Count what remains',
          text: 'Six take away two leaves four mangoes.',
        },
      ],
      question: {
        prompt:
        ...
        hintLadder: {
          hint1: 'Start with 6 and take away 2.',
          hint2: '6 - 2 = 4.',
