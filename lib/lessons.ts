...
export const lessons: Lesson[] = [
  // ----- Class 1 · Maths · Chapter 3 "Mango Treat" (site title "Mango Tree") -----
  {
    ...
    description: 'Count the animals as they join around the mango.',
    minutes: 5,
    steps: [
      {
        visual: '🐿️  +  🥭  =  1',
        title: 'One squirrel at the mango',
        text: 'A squirrel finds a mango. That is 1 animal.',
      },
      {
        visual: '🐿️  +  🐦  =  2',
        title: 'One bird joins',
        text: 'One bird joins the squirrel. Now 2 animals share the mango.',
      },
      {
        visual: '🐦 🐦  +  🐦  =  3',
        title: 'One more bird',
        text: 'One more bird comes along. Now 3 animals are eating.',
      },
      {
        visual: '🐦 🐦 🐦  +  🐦 🐦  =  5',
        title: 'Up to five',
        text: 'Two more birds join. Now 5 animals eat the mango.',
      },
      {
        visual: '🐦 🐦 🐦 🐦 🐦  +  🐦 🐦 🐦  +  🐿️  =  9',
        title: 'Nine friends at the mango',
        text: 'More animals join one by one. In the end, 9 animals ate the mango.',
      },
    ],
    question: {
      prompt: 'At the end, how many animals ate the mango?',
      options: ['5', '9', '3'],
      answer: 1,
      hint: 'Animals joined one by one until there were 9.',
    },
  },
  {
    id: 'mango-one-more',
    ...
    chapter: 'Mango Treat',
    title: 'One more',
    description: 'See what happens when one more is added.',
    minutes: 5,
    steps: [
      {
        visual: '🐦  =  1',
        title: 'One bird',
        text: 'One bird is eating the mango. Count: 1.',
      },
      {
        visual: '🐦  +  🐦  =  2',
        title: 'Add one more',
        text: 'One more bird joins. 1 and 1 more makes 2.',
      },
      {
        visual: '🐦 🐦  +  🐦  =  3',
        title: 'Two, then one more',
        text: '2 birds, then one more joins. Now there are 3.',
      },
      {
        visual: '🐦 🐦 🐦 🐦  +  🐦  =  5',
      ...
      },
      {
        ...
        title: 'Next number is one more',
        text: 'One more always gives the next number. Count forward by one.',
      },
    ],
    question: {
      ...
      options: ['4', '6', '8'],
      answer: 1,
      hint: 'Count forward from 5. The next number is 6.',
    },
  },
  {
    ...
    description: 'Match birds to the same number of fingers.',
    minutes: 5,
    steps: [
      {
        visual: '🐦  =  ✋  (1)',
        title: 'One bird, one finger',
        text: 'One bird matches one finger. They show the same number.',
      },
      {
        visual: '🐦 🐦 🐦  =  ✋ ✋ ✋  (3)',
        title: 'Three birds, three fingers',
        text: 'Three birds match three fingers. Same number, different things.',
      },
      {
        visual: '🐦 🐦 🐦 🐦 🐦  =  ✋ ✋ ✋ ✋ ✋  (5)',
        title: 'Five birds, five fingers',
        text: 'Five birds match five fingers. The two groups are equal.',
      },
      {
        visual: '🐦 🐦 🐦 🐦 🐦 🐦  →  ✋ ✋ ✋ ✋ ✋ ✋  (6)',
        title: 'Count then match',
        text: 'Count the birds. Then show the same number of fingers.',
      },
      {
        visual: '🐦 🐦 🐦 🐦 🐦 🐦 🐦 🐦 🐦  →  9  fingers',
        title: 'Your turn to match',
        text: 'Count the birds. Hold up the same number of fingers.',
      },
    ],
    question: {
      ...
      answer: 0,
      hint: 'One finger for each bird. Five birds need five fingers.',
    },
  },
  {
    id: 'fingers-and-dots',
    ...
    steps: [
      {
        ...
        text: 'One finger matches one dot. Same number.',
      },
      {
        visual: '✋ ✋  =  ● ●  (2)',
      ...
      },
      {
        visual: '✋ ✋ ✋ ✋  →  ● ● ● ●  (4)',
        title: 'Show four',
        text: 'Show 4 fingers. Find the group with 4 dots.',
      },
      {
        visual: '✋ ✋ ✋ ✋ ✋  =  ● ● ● ● ●  (5)',
        title: 'Count and match',
        text: 'Count the dots. Match them to the same number of fingers.',
      },
    ],
    question: {
      prompt: 'All fingers up on one hand. How many fingers?',
      options: ['5', '4', '6'],
      answer: 0,
      hint: 'One hand has five fingers. Count them: 1, 2, 3, 4, 5.',
    },
  },
  {
    id: 'same-number-ways',
    ...
    steps: [
      {
        visual: '2  =  🐦 🐦  =  ● ●',
        title: 'Two shown as birds and dots',
        text: 'Two birds and two dots both show the number 2.',
      },
      {
        visual: '4  =  ✋ ✋ ✋ ✋  =  ● ● ● ●',
        title: 'Four as fingers and dots',
        text: 'Four fingers and four dots both show the number 4.',
      },
      {
        visual: '7  =  🐦 🐦 🐦 🐦 🐦 🐦 🐦  =  ● ● ● ● ● ● ●',
        title: 'Seven as birds and dots',
        text: 'Seven birds and seven dots both show the number 7.',
      },
      {
        visual: '✌️ + ✌️  =  4',
        title: 'Four using two fingers',
        text: 'Show 2 fingers and 2 more fingers. Together they make 4.',
      },
      {
        visual: '✋ + ✋  =  6  (using different fingers)',
        title: 'Six in a new way',
        text: 'You can show 6 using fingers in different ways.',
      },
    ],
    question: {
    ...
    steps: [
      {
        ...
        text: 'Three apples and five bananas. Bananas are more.',
      },
      {
        visual: '🍎 🍎 🍎  =  3',
      ...
      },
      {
        ...
        text: 'Five is more than three. The bananas group wins.',
      },
      {
        visual: '🍎 🍎 🍎 🍎 🍎  =  🍌 🍌 🍌 🍌 🍌  (5 = 5)',
        title: 'Equal groups',
        text: 'Five apples and five bananas are equal. Same number.',
      },
    ],
    question: {
      ...
      answer: 1,
      hint: 'Five is bigger than three. Count to check.',
    },
  },
  {
    ...
    description: 'Meet the numerals 1 to 9 and their groups.',
    minutes: 6,
    steps: [
      {
        visual: '1  =  ☀️',
        title: 'One sun',
        text: 'One sun in the sky. The numeral 1 means one thing.',
      },
      {
        visual: '2  =  🐤 🐤',
        title: 'Two chicks',
        text: 'Two chicks. The numeral 2 means two things.',
      },
      {
        visual: '3  =  🍃 🍃 🍃',
        title: 'Three leaves',
        text: 'Three leaves. The numeral 3 means three things.',
      },
      {
        visual: '⭐ ⭐ ⭐ ⭐ ⭐ ⭐ ⭐  =  7',
        title: 'Seven stars',
        text: 'Count the stars: 1 to 7. The numeral 7 means seven things.',
      },
      {
        visual: '1  →  2  →  3  →  4  →  5  →  6  →  7  →  8  →  9',
        title: 'Count to nine',
        text: 'Each numeral from 1 to 9 stands for that many things.',
      },
    ],
    question: {
      ...
      options: ['5', '7', '9'],
      answer: 1,
      hint: 'Count seven stars: 1, 2, 3, 4, 5, 6, 7.',
    },
  },
  {
    id: 'count-and-match',
    ...
    steps: [
      {
        visual: '🌸 🌸  →  2',
        title: 'Two flowers match two',
        text: 'Two flowers match the numeral 2.',
      },
      {
        visual: '🐘 🐘 🐘 🐘 🐘  →  5',
        title: 'Five elephants',
        text: 'Count the elephants: 1, 2, 3, 4, 5. That is 5.',
      },
      {
        visual: '🏠 🏠 🏠 🏠 🏠 🏠 🏠  →  7',
        title: 'Seven houses',
  ...
  },
  {
    ...
    description: 'Put numbers 1 to 9 from smallest to biggest.',
    minutes: 6,
    steps: [
      {
        visual: '2  →  3  →  4',
        title: 'Count in order',
        text: 'After 2 comes 3, then 4. Numbers walk forward by one.',
      },
      {
        visual: '1  2  3  4  5',
        title: 'Smallest first',
        text: 'Start from the smallest: 1, 2, 3, 4, 5.',
      },
      {
        visual: '5  →  6  →  7  →  8  →  9',
        title: 'Up to nine',
      ...
      },
      {
        ...
        text: 'Cards are mixed up. Put them from smallest to biggest.',
      },
      {
        visual: '1  2  3  4  5  6  7  8  9',
        title: 'All in a line',
        text: 'From 1 to 9, each number is one bigger than the last.',
      },
    ],
    question: {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        text: 'Two numbers are missing. Fill in the gaps.',
      },
      {
        visual: '4  5  6  7  8',
        title: 'The complete line',
        text: 'The counting line is now complete: 4, 5, 6, 7, 8.',
      },
      {
        visual: '__  2  __  4  5',
        title: 'Try this one',
        text: 'What comes before 2? What is between 2 and 4?',
      },
      {
        visual: '1  2  3  4  5',
        title: 'Complete counting lines',
        text: 'Fill each gap so the count goes up by one.',
      },
    ],
    question: {
      ...
      options: ['4', '2', '5'],
      answer: 0,
      hint: 'Count forward: 1, 2, 3, then 4.',
    },
  },
  {
    id: 'biggest-number',
    ...
    steps: [
      {
        visual: '3  ·  6  ·  9  →  biggest: 9',
        title: 'Compare three numbers',
        text: 'Look at 3, 6, and 9. Which is the biggest?',
      },
      {
        visual: '3  <  6',
      ...
      {
        visual: '6  <  9',
        title: 'Nine is biggest of all',
        text: 'Nine comes after six. So 9 is the biggest.',
      },
      {
        visual: '3  ·  6  ·  9  →  colour 9',
        title: 'Colour the biggest',
        text: 'Find the biggest number and colour it.',
      },
      {
        visual: '1  ·  9  ·  5  →  biggest: 9',
    ...
    question: {
      ...
      options: ['2', '7', '5'],
      answer: 1,
      hint: 'Seven is further along the counting line than 2 or 5.',
    },
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        text: 'Count each jamun: 1, 2, 3, 4.',
      },
      {
        visual: '🐑 🐑 🐑 🐑 🐑  =  5',
        title: 'Count the sheep',
        text: 'Count the sheep: 1, 2, 3, 4, 5.',
      },
      {
        visual: 'count  →  write the number',
        title: 'Count and write',
        text: 'Count the things in the picture. Write the number.',
      },
    ],
    question: {
    ...
    steps: [
      {
        ...
        text: 'Here are apples and bananas. Two separate groups.',
      },
      {
        visual: '🍎 🍎 🍎  +  🍌 🍌 🍌 🍌 🍌  =  8',
      ...
      {
        visual: '3  +  5  =  8',
        title: 'Write it with numbers',
        text: 'Three plus five equals eight.',
      },
      {
        visual: '☂️ ☂️ ☂️ ☂️  +  ☂️ ☂️ ☂️  =  7',
        title: 'Seven umbrellas',
        text: 'Four umbrellas and three more make 7 umbrellas.',
      },
      {
        visual: 'group A  +  group B  →  count all',
        title: 'Count both groups',
        text: 'Join the groups. Count every object to find the total.',
      },
    ],
    question: {
  ...
  },
  {
    ...
    description: 'Put the right number of objects on each number card.',
    minutes: 5,
    steps: [
      {
        visual: '5  =  🐦 🐦 🐦 🐦 🐦',
        title: 'Five objects on card five',
        text: 'The card says 5. Place 5 things on it.',
      },
      {
        visual: '3  =  🍎 🍎 🍎',
        title: 'Three objects on card three',
        text: 'The card says 3. Place exactly 3 objects on it.',
      },
      {
        visual: '8  =  ● ● ● ● ● ● ● ●',
        title: 'Eight objects on card eight',
        text: 'The card says 8. Place exactly 8 dots on it.',
      },
      {
        visual: '1  →  ●    2  →  ● ●    …    9  →  ● ● ● ● ● ● ● ● ●',
        title: 'Cards one to nine',
        text: 'Make cards from 1 to 9. Each card holds its own number.',
      },
      {
        visual: 'your card  →  draw or stick objects',
        title: 'Make your own cards',
        text: 'Draw or stick objects to show each number on its card.',
      },
    ],
    question: {
